...
# Match the shared MXFP8/NVFP4 scale distributions without modifying kernels.
...
"$cmake" -S "$cutlass" -B "$build" -GNinja \
  ...
  -DCUTLASS_LIBRARY_KERNELS='cutlass3x_sm107_bstensorop_gemm_ue4m3xe2m1_ue4m3xe2m1_f32_bf16_bf16,cutlass3x_sm107_bstensorop_gemm_ue8m0xe4m3_ue8m0xe4m3_f32_void_bf16,cutlass3x_sm107_tensorop_gemm_e4m3_e4m3_f32_bf16_bf16' \
