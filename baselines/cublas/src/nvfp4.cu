...
constexpr AlgorithmConfig kWinners[] = {
    {.size = 1024,  .tile = 20, .stages = 37, .custom = 2, .cluster = 5},
    {.size = 2048,  .tile = 23, .stages = 37, .custom = 3, .cluster = 9},
    {.size = 4096,  .tile = 23, .stages = 37, .custom = 3, .cluster = 6},
    {.size = 8192,  .tile = 24, .stages = 37, .custom = 0, .cluster = 8},
    {.size = 16384, .tile = 24, .stages = 37, .custom = 0, .cluster = 8},
    {.size = 32768, .tile = 23, .stages = 38, .custom = 1, .cluster = 6},
};
  ...
  explicit Nvfp4Workload(int size)
    ...
    for (int group = 0; group < groups_; ++group) {
      ...
      fill_uniform(a_[group], a_.elements(), seed,
                   BENCHMARK_NVFP4_PACKED_LOW, BENCHMARK_NVFP4_PACKED_HIGH);
